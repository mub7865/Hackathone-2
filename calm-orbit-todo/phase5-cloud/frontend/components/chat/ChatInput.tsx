...
export function ChatInput({
  ...
  return (
    <div className="flex items-end gap-2 sm:gap-3 p-2 sm:p-4 bg-background-elevated border-t border-border-subtle">
      {/* Input textarea */}
      <textarea
        ref={textareaRef}
        value={message}
        ...
        rows={1}
        className={`
          flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-xl resize-none
          ...
          text-sm sm:text-body-sm leading-relaxed
        `}
