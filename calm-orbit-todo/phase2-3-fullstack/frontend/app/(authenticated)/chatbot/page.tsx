 ...
 * Feature: 009-compliance-fixes (ChatKit integration with feature flag)
 *
 * - Conditionally renders ChatKit or legacy chat based on feature flag
 * - Sidebar with conversation history (legacy)
 * - Chat area with messages and input (legacy)
 * - New Chat functionality
 * - Mobile responsive with hamburger menu
 */
export default function ChatbotPage() {
  // Check feature flag for ChatKit
  const useNewChat = isFeatureEnabled('useNewChat');

  // If ChatKit is enabled, render ChatKit page
  if (useNewChat) {
    return <ChatKitPage />;
  }

  // Otherwise, render legacy chat page
  return <LegacyChatPage />;
}

/**
 * Legacy chat page implementation
