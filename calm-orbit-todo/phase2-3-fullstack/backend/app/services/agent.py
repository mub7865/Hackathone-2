...
# Production/K8s: http://localhost:8000/mcp/mcp (Agent connects locally within the pod)
# For internal pod communication in K8s, we still use localhost as both agent and MCP server run in same pod
